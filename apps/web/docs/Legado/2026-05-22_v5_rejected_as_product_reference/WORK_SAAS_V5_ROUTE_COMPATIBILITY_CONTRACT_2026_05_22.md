# Work SaaS V5 Route Compatibility Contract

Date: 2026-05-22  
Status: V5 technical contract retained from the previous route compatibility contract. The old V3 filename is archived in `Legado/2026-05-22_pre_v5_archived/`.

This document protects route compatibility during the V5 SaaS restructure. It does not override the V5 UX, navigation or page-responsibility specs.
...
- V5 can change navigation labels and grouping, but must keep these module segments or route wrappers.
...
- V5 target keeps Calendar first-class and reduces Reservations submenu clutter, but route aliases remain.
...
- V5 target moves professor/equipe concerns to People/Equipe where appropriate, but legacy views must keep loading.
...
- V5 target reclassifies this under Pessoas, but current routes stay compatible.
...
- V5 target renames the domain to Receita in Work SaaS, but preserves `/financeiro`.
