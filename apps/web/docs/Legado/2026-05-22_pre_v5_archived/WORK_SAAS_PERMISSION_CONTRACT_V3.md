# Work SaaS Permission Contract V3

Date: 2026-05-21  
Queue: `WSAAS3-00C`  
Status: Phase 0A contract, created from `src/lib/place-management.ts`, `src/lib/workspace-access.ts`, `src/lib/role-visibility.ts` and current product target.
