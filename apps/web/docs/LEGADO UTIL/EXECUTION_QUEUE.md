...
- validar jogador puro;
- validar organizador;
- validar inscrito;
- validar mobile 390px;
- rodar lint/build.
...
- gaps documentados: papel financeiro dedicado, operador de cantina/POS e maior detalhamento futuro de `workspace-access.ts`.
